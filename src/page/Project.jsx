      ...
      <div className=" my-[40px] flex justify-center">
        <div className="my-[80px] w-[1200px] flex justify-around">
          <div className=" w-[500px] h-[200px]">
            ...
            <a href="https://main--testtododoto.netlify.app/" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
